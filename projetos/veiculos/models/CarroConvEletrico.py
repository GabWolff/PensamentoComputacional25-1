...
class CarroConvEletrico(carroCombustao, carroEletrico):
    ...
    def __init__(self, modelo: str, marca: str, ano: int, cor: str, placa: str, fipe: float, combustivel: str, 
                 nPortas: int, nAssentos: int, nCilindradas: int, nCambio: str, nivelCombustivel: int, nivel_bateria: int,
                 tipo_bateria: str, autonomia: int) -> None:
        """ Construtor da classe CarroConvEletrico"""
        # Inicializa os atributos da classe pai
        super().__init__(modelo, marca, ano, cor, placa, fipe, combustivel, nPortas, nAssentos, nCilindradas, nCambio, nivelCombustivel)
        
        carroEletrico.__init__(self, placa, marca, modelo, ano, cor, fipe, nAssentos, nPortas, nivel_bateria, tipo_bateria, autonomia)
